		...
		methods: {
			...
			async loadTree() {
				...
				try {
					...
					let url = '/php_modules/kantor/controller_tree.php';
					const response = await axios.get(url, { params: this.sourceTree });
			...
			async loadContent(el) {
				if (el.getAttribute('for')) {
					...
					let urlSourceTree = '/php_modules/kantor/source_controller.php';
					try {
